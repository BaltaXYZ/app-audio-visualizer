...
export function LyricsPanel({
  ...
  }, [activeLineIndex, draftDirty, draftText]);
  ...
  return (
    <section className="lyrics-card" aria-label="Lyrics">
      ...
      <div className="lyrics-timing">
        ...
        <p className="lyrics-time">Current time {formatLyricTime(currentTime)}</p>
        <div className="settings-actions">
          <button
            type="button"
            className="secondary-button"
      ...
      <div className="settings-panel" aria-label="Lyric style settings">
        ...
        <label className="control-field">
          ...
          <input
            ...
            onChange={(event) =>
              onSettingChange("fontSize", Number(event.currentTarget.value))
            }
          />
        </label>
